...
loggerIndexing = setup_logger('Indexing')
loggerUtils = setup_logger('Utils')
loggerWorkflow = setup_logger('Workflow')
loggerTelemetry = setup_logger('Telemetry')
loggerServer = setup_logger('Server')
loggerMain = setup_logger('Main')